...
public class BigQuestionsController extends BaseAllController<BigQuestion> {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(dataTypeClass = BigQuestion.class, required = true, paramType = "from")
    })
    ...
    @ApiImplicitParam(value = "子项小题id", required = true, dataType = "string", paramType = "from")
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(value = "修改人id", name = "teacherId", dataType = "string", paramType = "from", required = true),
            @ApiImplicitParam(value = "修改的子项id", name = "childrenId", dataType = "string", paramType = "from", required = true),
            @ApiImplicitParam(value = "修改的对象json字符串", name = "json", dataType = "string", paramType = "from", required = true)
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(value = "修改人id", name = "teacherId", dataType = "string", paramType = "from", required = true),
            @ApiImplicitParam(value = "修改的对象字json符串", name = "json", dataType = "string", paramType = "from", required = true),
            @ApiImplicitParam(value = "大题id", name = "questionId", dataType = "string", paramType = "from", required = true)
    })
